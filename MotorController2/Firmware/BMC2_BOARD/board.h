...
/*
 * Setup for STMicroelectronics F405RG .
 */

/*
 * Board identifier.
 */
#define BOARD_ST_BMC2_F405RG
#define BOARD_NAME                  "BMC2"
...
#define LINE_BUTTON                 PAL_LINE(GPIOB, 2U)
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_PIN0) |          \
                                     ...
                                     PIN_OSPEED_MEDIUM(GPIOA_PIN9) |          \
                                     PIN_OSPEED_MEDIUM(GPIOA_PIN10) |         \
 ...
 * GPIOB setup:
 *
 * PB0  - 5V MONITOR                (analog in).
 * PB1  - TEMP DRV                  (analog in).
 * PB2  - BUTTON                    (input pullup).
 * PB3  - SWO                       (alternate 0).
 * PB4  - JTRST (Option)            (input pullup).
 * PB5  - CAN_STBY                  (output).
 * PB6  - USART1_TX                 (alternate ?).
 * PB7  - USART1_RX                 (alternate ?).
 * PB8  - CAN_TX                    (alternate ?).
 * PB9  - CAN_RX                    (alternate ?).
 * PB10 - I2C_SCL/USART3_TX         (input pullup).
 * PB11 - I2C_SDA/USART3_RX         (input pullup).
 * PB12 - W14                       (output).
 * PB13 - INLC                      (output).
 * PB14 - INLB                      (output).
 * PB15 - INLA                      (output).
 ...
 * PC2  - HALLC                     (analog in).
 * PC3  - TEMP                      (analog in).
 * PC4  - LED_GREEN                 (output).
 * PC5  - LED_YELLOW                (output).
 * PC6  - ENDSTOP1                  (input pullup).
 * PC7  - ENDSTOP2                  (input pullup).
 * PC8  - INDEX                     (input pullup).
 * PC9  - sSCS                      (output).
 * PC10 - SCLK                      (x).
 * PC11 - MISO                      (x).
 * PC12 - MOSI                      (x).
